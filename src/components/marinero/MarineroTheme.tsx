      ...
      <section className="py-16 px-4 relative z-10">
        <div className="max-w-2xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-10">
            ...
            <p className="text-sky-500 text-xs mt-1 italic">
              Datos oficiales obtenidos a través del INE (Instituto Nacional de Estadística) · Fuente verificada
            </p>
            <div className="w-16 h-0.5 bg-sky-500 mx-auto mt-4" />
          </motion.div>
    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-50 w-11 h-11 rounded-full bg-sky-600 text-white shadow-lg shadow-sky-600/40 flex items-center justify-center text-lg hover:bg-sky-500 transition-colors"
