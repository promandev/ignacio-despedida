    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-50 w-11 h-11 rounded-full bg-emerald-600 text-white shadow-lg shadow-emerald-600/40 flex items-center justify-center text-lg hover:bg-emerald-500 transition-colors"
